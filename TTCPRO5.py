...
\033[1;33m==========================================================
                 \033[1;35mTOOL TTC FACEBOOK
\033[1;33m=========================================================
"""
    print(banner_text, flush=True)

# Gọi banner một lần duy nhất
banner()
...
def _delay(value):
	while not(value <= 1):
		value -= 0.123
		print(f'''\033[1;39m[\033[1;36mTOOL\033[1;39m][ \033[1;36mDELAY \033[1;39m][\033[1;36m{str(value)[0:5]}\033[1;39m][\033[1;33mX  \033[1;39m ]''', '               ', end = '\r')
		sleep(0.025)
		print(f'''\033[1;39m[\033[1;36mTOOL\033[1;39m][ \033[1;36mDELAY \033[1;39m][\033[1;36m{str(value)[0:5]}\033[1;39m][\033[1;33m X   \033[1;39m]''', '               ', end = '\r')
		sleep(0.025)
		print(f'''\033[1;39m[\033[1;36mTOOL\033[1;39m][ \033[1;36mDELAY \033[1;39m][\033[1;36m{str(value)[0:5]}[ \033[1;33m  X  \033[1;39m]''', '               ', end = '\r')
		sleep(0.025)
		print(f'''\033[1;39m[\033[1;36mTOOL\033[1;39m][ \033[1;36mDELAY \033[1;39m][\033[1;36m{str(value)[0:5]}\033[1;39m][\033[1;33m   X \033[1;39m]''', '               ', end = '\r')
		sleep(0.025)
		print(f'''\033[1;39m[\033[1;36mTOOL\033[1;39m][ \033[1;36mDELAY \033[1;39m][\033[1;36m{str(value)[0:5]}\033[1;39m][\033[1;33m    X\033[1;39m]''', '               ', end = '\r')
